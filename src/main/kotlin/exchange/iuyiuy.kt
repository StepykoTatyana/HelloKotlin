...
fun main() {
    val inputFile = File("C:\\IdeaProjects\\HelloKotlin\\src\\main\\kotlin\\exchange\\plane-in-sunset.jpg")  // Create a file instance in order to read the "24bit.png" image file
    ...
    val outputFileJpg = File("C:\\IdeaProjects\\HelloKotlin\\src\\main\\kotlin\\exchange\\newImageFile.jpg")  // Output the file
    ...
    val outputFile = File("C:\\IdeaProjects\\HelloKotlin\\src\\main\\kotlin\\exchange\\alpha.png")         // Output the image
